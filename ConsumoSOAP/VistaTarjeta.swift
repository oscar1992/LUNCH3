...
class VistaTarjeta: UIView {
    ...
    func botonElimina(){
        ...
        elimina.addTarget(self, action: #selector(VistaTarjeta.mensajeAprueba), for: .touchDown);
    ...
    func mensajeAprueba(){
        ...
        let frame1 = CGRect(x: OX1, y: OY, width: ancho, height: alto);
        let frame2 = CGRect(x: OX2, y: OY, width: ancho, height: alto);
        botonA = UIButton(frame: frame1);
        botonC = UIButton(frame: frame2);
        botonA.addTarget(self, action: #selector(VistaTarjeta.eliminaTarjeta), for: .touchDown);
        botonC.addTarget(self, action: #selector(VistaTarjeta.cierraMsg), for: .touchDown);
