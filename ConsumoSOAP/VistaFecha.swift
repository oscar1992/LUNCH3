...
class VistaFecha: UIView {
    ...
    func iniciaOpciones(opciones: [(String, String, Int)]){
    ...
    func titulo(){
        ...
        titulo.text="¿Que día quieres recibir Las Loncheras?";
    ...
    func cierraBot(){
        ...
        botcer.addTarget(self, action: #selector(VistaFecha.cierra), forControlEvents: .TouchDown);
