...
class RespuestaFavorita: UIView {
    ...
    init(frame: CGRect, sub: Int) {
        ...
        iniciaImagen()
        poneMensaje(sub);
        _ = NSTimer.scheduledTimerWithTimeInterval(2, target: self, selector: #selector(RespuestaFavorita.cierraLetrero), userInfo: nil, repeats: false);
    }
