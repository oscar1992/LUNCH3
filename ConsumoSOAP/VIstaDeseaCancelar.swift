...
class VIstaDeseaCancelar: UIView {
    ...
    func iniciaBotones(){
        ...
        bot2.addTarget(self, action: #selector(VIstaDeseaCancelar.cierraVista), forControlEvents: .TouchDown);
        bot1.addTarget(self, action: #selector(VIstaDeseaCancelar.cancelaPedido), forControlEvents: .TouchDown);
    }
